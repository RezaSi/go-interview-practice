...
func (e *AccountError) Error() string {
	...
	return fmt.Sprintf("invalid %v", e.data)
}
...
func (e *InsufficientFundsError) Error() string {
	// Implement error message
	return fmt.Sprintf("insufficient balance %f", e.balance)
}
...
func (e *ExceedsLimitError) Error() string {
	// Implement error message
	return fmt.Sprintf("transaction amount %f exceeding %f", e.amount, MaxTransactionAmount)
}
